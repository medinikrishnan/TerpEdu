...
Revision ID: c62c0999ba5c
Revises: 
Create Date: 2024-11-20 05:03:14.272314
...
def upgrade():
    ...
    op.create_table('stu_enrollments',
    sa.Column('stu_enroll', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('course_id', sa.Integer(), nullable=False),
    sa.Column('enrollment_date', sa.TIMESTAMP(), nullable=True),
    sa.ForeignKeyConstraint(['course_id'], ['courses.course_id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.UserID'], ),
    sa.PrimaryKeyConstraint('stu_enroll')
    )
